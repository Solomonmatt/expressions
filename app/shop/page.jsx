    ...
    <>
      ...
      <div className="tf-page-title">
        <div className="container-full">
          <div className="heading text-center">Shops</div>
          <p className="text-center text-2 text_black-2 mt_5">
            Shop through our latest selection of Unique Hairs
          </p>
        </div>
      </div>
      {/* /page-title */}
                      ...
                      <div className="card-product style-brown">
                        <div className="card-product-wrapper rounded-0">
                          <a href="#" className="product-img ">
                            ...
                            />
                            <img
                              className="lazyload img-hover rounded-md"
                              src={urlFor(product.image).url()}
                              alt="image-product"
                            />
                          </a>
                        ...
                        <div className="card-product-info">
                          <a
                            href="#"
                            className="title link font-poppins text-black font-bold text-xl"
                          >
                            {product?.name}
                          </a>
